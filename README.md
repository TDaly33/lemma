...
- `--punct-variants N`: Trailing/leading punctuation index variants for the headword plus its top N frequency-ranked inflections (default: 20, `0` disables). See "Punctuation-Attached Lookup" above.
